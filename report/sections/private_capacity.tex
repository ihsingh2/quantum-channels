...
The private capacity $P(\mathcal{N})$ of a quantum channel $\mathcal{N}$ is defined as follows, analogous to the private capacity of a wiretap channel. Here, we replace the classical mutual information with quantum mutual information, and the maximization is over all the classical quantum states described earlier.
